...
const Details = () => {
 ...
 return (
  ...
  <div className="hero-content flex-col lg:flex-row justify-evenly w-4/5 h-3/5 p-4 shadow-xl ">
    ...
    <div>
      <h1 className="text-2xl">Name: <span className='text-lg font-bold text-[#ff3300]'>{name}</span></h1>
      <h1 className="text-2xl">Seller Name:<span className='text-lg text-gray-600 font-bold'>{seller_name}</span></h1>
